...
function TodoDialog(props) {
	...
	const todoDialog = useSelector(({ chambres }) => chambres.todos.todoDialog);
					...
					<div className='flex items-center justify-between p-12'>
						...
						<div className='flex items-center justify-start' aria-label='Toggle star'>
							<IconButton onClick={handleToggleImportant}>
								{form.important ? <Icon style={{ color: red[500] }}>error</Icon> : <Icon>error_outline</Icon>}
							</IconButton>

							<IconButton onClick={handleToggleStarred}>
								{form.starred ? <Icon style={{ color: amber[500] }}>star</Icon> : <Icon>star_outline</Icon>}
							</IconButton>
							<div>
								<IconButton
							...
							<Chip
								avatar={
									<Avatar classes={{ colorDefault: 'bg-transparent' }}>
										<Icon className='text-20' style={{ color: _.find(labels, { id: label }).color }}>
											label
										</Icon>
									</Avatar>
								}
