...
function DossiersBourseHeader(props) {
		...
		<div className='flex flex-1 w-full items-center justify-between'>
			<div className='flex items-center'>
				<FuseAnimate animation='transition.expandIn' delay={300}>
					<Icon className='text-32 mr-0 sm:mr-12'>attach_money</Icon>
				</FuseAnimate>
				<FuseAnimate animation='transition.slideLeftIn' delay={300}>
					<Typography className='hidden sm:flex' variant='h6'>
						Liste des Dossiers de Bourses
					</Typography>
				</FuseAnimate>
			</div>
			...
			<FuseAnimate animation='transition.slideRightIn' delay={300}>
				<Button component={Link} to='/bourses/dossiers/new' className='whitespace-no-wrap' variant='contained'>
...
export default DossiersBourseHeader;
