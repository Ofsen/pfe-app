...
function CampusResidence(props)
{
    const dispatch = useDispatch();
    const course = useSelector(({CampusResidences}) => CampusResidences.CampusResidencesReducer);
...
export default withReducer('campusResidences', reducer)(CampusResidence);
