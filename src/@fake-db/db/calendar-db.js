...
let calendarDB = {
	events: [
		{
			id: 0,
			title: 'A Recurring Event',
			allDay: false,
			start: new Date(Date.UTC(2021, 6, 7, 10, 45, 0)),
			end: new Date(Date.UTC(2021, 6, 7, 11, 45, 0)),
			recurrent: true,
			dtstart: new Date(Date.UTC(2021, 6, 7, 10, 45, 0)),
			until: new Date(Date.UTC(2021, 7, 8, 10, 45, 0)),
			interval: 1,
			freq: RRule.WEEKLY,
		},
		{
			...
			allDay: false,
			recurrent: false,
			start: new Date(Date.UTC(2021, 6, 7, 11, 45, 0)),
			end: new Date(Date.UTC(2021, 6, 8, 11, 45, 0)),
			dtstart: null,
			until: null,
			interval: null,
			freq: null,
