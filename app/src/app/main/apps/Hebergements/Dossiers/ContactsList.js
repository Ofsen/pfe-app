...
function ContactsList(props)
{
    ...
    const contacts = useSelector(({campus}) => campus.contacts.entities);
    const selectedContactIds = useSelector(({campus}) => campus.contacts.selectedContactIds);
    const searchText = useSelector(({campus}) => campus.contacts.searchText);
    const user = useSelector(({campus}) => campus.user);
