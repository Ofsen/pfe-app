...
function TodoSidebarContent(props) {
	...
	const folders = useSelector(({ chambres }) => chambres.folders);
	const filters = useSelector(({ chambres }) => chambres.filters);
		...
		<FuseAnimate animation='transition.slideUpIn' delay={400}>
			<div className='flex-auto border-l-1 border-solid'>
				...
				<div className={classes.listWrapper}>
					...
					<List>
						<ListSubheader className='pr-24 pl-24' disableSticky>
							LABELS
						</ListSubheader>
